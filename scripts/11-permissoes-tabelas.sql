...
-- =====================================================
-- 3. TABELA DE RELACIONAMENTO ROLE-PERMISSIONS
-- =====================================================
...
-- =====================================================
-- 4. TABELA DE RELACIONAMENTO USER-ROLES
-- =====================================================
...
BEGIN
    ...
    RAISE NOTICE 'Todas as tabelas de permissões foram criadas com sucesso!';
    RAISE NOTICE 'Permissões inseridas: %', (SELECT COUNT(*) FROM permissions);
    RAISE NOTICE 'Roles inseridos: %', (SELECT COUNT(*) FROM roles);
    RAISE NOTICE 'Relacionamentos role-permission inseridos: %', (SELECT COUNT(*) FROM role_permissions);
END $$;
