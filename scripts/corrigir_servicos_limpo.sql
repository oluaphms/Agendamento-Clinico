-- =====================================================
-- CORRIGIR PÁGINA SERVIÇOS - SCRIPT LIMPO
-- =====================================================
-- Este script corrige os problemas da página de Serviços
-- removendo todos os triggers problemáticos

-- 1. REMOVER APENAS TRIGGERS DA TABELA SERVIÇOS
-- =====================================================

-- Remover apenas os triggers específicos da tabela servicos
DROP TRIGGER IF EXISTS trigger_update_servicos_updated_at ON servicos;
DROP TRIGGER IF EXISTS update_servico_updated_at ON servicos;
DROP TRIGGER IF EXISTS update_servicos_updated_at ON servicos;
DROP TRIGGER IF EXISTS set_updated_at ON servicos;

-- Remover apenas a função específica de serviços (se existir)
DROP FUNCTION IF EXISTS update_servicos_updated_at();
...
-- Verificar se não há triggers problemáticos
SELECT 
