-- =====================================================
-- SCRIPT PARA PÁGINA PROFISSIONAIS
-- =====================================================
...
-- Profissionais por subespecialidade
SELECT 
    'Profissionais por Subespecialidade' as categoria,
    COALESCE(subespecialidade, 'Sem subespecialidade') as subespecialidade,
    COUNT(*) as quantidade
FROM profissionais 
WHERE ativo = true
GROUP BY subespecialidade
ORDER BY quantidade DESC;
