-- =====================================================
-- CORRIGIR PÁGINA SERVIÇOS - IDENTIFICAR E DESABILITAR TRIGGER
-- =====================================================
-- Este script identifica e desabilita o trigger problemático da tabela servicos

-- 1. IDENTIFICAR TRIGGERS ATIVOS
-- =====================================================

-- Listar todos os triggers da tabela servicos
SELECT 
    'TRIGGERS ATIVOS NA TABELA SERVIÇOS' as info,
    trigger_name,
    event_manipulation,
    action_timing,
    action_condition
...
-- 2. DESABILITAR TODOS OS TRIGGERS DA TABELA SERVIÇOS
-- =====================================================

-- Desabilitar todos os triggers da tabela servicos
DO $$
DECLARE
    trigger_record RECORD;
BEGIN
    -- Buscar todos os triggers da tabela servicos
    ...
    LOOP
        -- Desabilitar cada trigger encontrado
        EXECUTE 'ALTER TABLE servicos DISABLE TRIGGER ' || trigger_record.trigger_name;
...
-- Verificar status dos triggers após desabilitação
SELECT 
    'TRIGGERS APÓS DESABILITAÇÃO' as info,
    trigger_name,
    event_manipulation,
    action_timing,
    action_condition
