...
export const TemplateEditor: React.FC<TemplateEditorProps> = ({
  ...
  const updateField = () => {
    if (editingFieldIndex === null || !newField.name || !newField.label || !newField.type) return;
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <h4 className="text-sm font-medium text-gray-900">Campos do Template</h4>
                <button
          ...
          <div className="mt-6">
            ...
            <p className="text-xs text-gray-500 mt-1">
              Use variáveis com a sintaxe {`{{variavel}}`}. Exemplo: {`{{nome}}, {{data}}, {{valor}}`}
            </p>
          </div>
