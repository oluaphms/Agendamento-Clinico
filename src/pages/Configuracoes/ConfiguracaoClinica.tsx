...
const ConfiguracaoClinica: React.FC = () => {
  ...
  const [configuracao, setConfiguracao] = useState<ConfiguracaoClinica | null>(
    null
  );
  ...
  const configuracoesFiltradas = configuracoes.filter(config => {
    ...
    const matchesCategoria =
      !filtros.categoria || config.tipo === filtros.categoria;
    const matchesAtivo =
      !filtros.ativo ||
  ...
  return (
    <div className='min-h-screen bg-gray-50 dark:bg-gray-900 p-6'>
      <Helmet>
        ...
        <meta
          name='description'
          content='Configurações gerais da clínica e sistema'
        />
      </Helmet>
              ...
              <div className='space-y-4'>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={e =>
                      setFormData({ ...formData, formato_hora: e.target.value })
                    }
                    className='w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white'
                  >
            ...
            <div className='space-y-4'>
              {configuracoesFiltradas.map(config => (
                ...
                >
                  <div className='flex items-center space-x-4'>
                    <div
                      className={`p-2 rounded-lg ${getCategoriaColor(config.tipo)} bg-opacity-10`}
                    >
